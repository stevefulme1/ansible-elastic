...
DOCUMENTATION = r"""
---
module: elastic_ml_datafeed
short_description: Manage Elasticsearch ML datafeeds
description:
    - Manage Elasticsearch ML datafeeds.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.elastic.elastic_ml_datafeed:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("datafeed_id",))],
    )
