"""Unit tests for stevefulme1.elastic.ingest_pipeline module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.elastic.plugins.modules.ingest_pipeline"
CLIENT_PATH = "ansible_collections.stevefulme1.elastic.plugins.module_utils.api_client"


def _build_resource(**overrides):
    """Return a mock ingest_pipeline resource dict."""
    base = {
        "id": "res-123",
        "_meta": "test-_meta",
        "deprecated": "test-deprecated",
        "description": "test-description",
        "field_access_pattern": "test-field_access_pattern"
    }
...
def resource_args(module_args):
    """Module args for ingest_pipeline operations."""
    module_args.update({
        "state": "present",
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.elastic.plugins.modules.ingest_pipeline import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.elastic.plugins.modules.ingest_pipeline import build_payload
