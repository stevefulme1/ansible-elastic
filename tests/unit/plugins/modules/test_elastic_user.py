"""Unit tests for stevefulme1.elastic.elastic_user module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.elastic.plugins.modules.elastic_user"
CLIENT_PATH = "ansible_collections.stevefulme1.elastic.plugins.module_utils.api_client"


@pytest.fixture
def mock_api_client():
    """Mock API client for elastic_user."""
    client = MagicMock()
    client.get.return_value = None
    client.create.return_value = {"username": "test-user"}
    client.update.return_value = {"username": "test-user-updated"}
