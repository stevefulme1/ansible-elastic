...
DOCUMENTATION = r"""
---
module: elastic_realm
short_description: Elasticsearch realm information
description:
    - Elasticsearch realm information.
version_added: "1.0.0"
author:
...
EXAMPLES = r"""
- name: Create
  stevefulme1.elastic.elastic_realm:
...
def main():
    module = AnsibleModule(
        ...
        required_if=[("state", "absent", ("realm_name",))],
    )
