"""Unit tests for stevefulme1.elastic.connector module."""
...
def resource_args(module_args):
    """Module args for connector operations."""
    module_args.update({
        "state": "present",
...
class TestGetCurrentState:
    ...
    def test_handles_client_error_not_found(self, resource_args):
        ...
        mock_client = MagicMock()
        mock_client.get.side_effect = ClientError("resource not_found", status_code=404)
    ...
    def test_raises_client_error_other(self, resource_args):
        ...
        mock_client = MagicMock()
        mock_client.get.side_effect = ClientError("500 internal server error", status_code=500)
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.elastic.plugins.modules.connector import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.elastic.plugins.modules.connector import build_payload
...
class TestCreate:
    ...
    def test_create_sets_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        with patch(f"{MODULE_PATH}.get_current_state", return_value=None):
            from ansible_collections.stevefulme1.elastic.plugins.modules.connector import main
            main()
