"""Unit tests for stevefulme1.elastic.logstash_pipeline module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.elastic.plugins.modules.logstash_pipeline"
CLIENT_PATH = "ansible_collections.stevefulme1.elastic.plugins.module_utils.api_client"


def _build_resource(**overrides):
    """Return a mock logstash_pipeline resource dict."""
    base = {
        "id": "res-123",
        "description": "test-description",
        "last_modified": "test-last_modified",
        "pipeline": "test-pipeline",
        "pipeline_metadata": "test-pipeline_metadata"
    }
...
def resource_args(module_args):
    ...
    module_args.update({
        ...
        "pipeline": "test-pipeline",
        "pipeline_metadata": "test-pipeline_metadata",
        "pipeline_settings": "test-pipeline_settings",
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.elastic.plugins.modules.logstash_pipeline import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.elastic.plugins.modules.logstash_pipeline import build_payload
...
class TestCreate:
    ...
    def test_create_sets_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        with patch(f"{MODULE_PATH}.get_current_state", return_value=None):
            from ansible_collections.stevefulme1.elastic.plugins.modules.logstash_pipeline import main
            main()
